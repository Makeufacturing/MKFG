...
Sharing is a two-way street that builds connection between people. Consider new ways of letting  customers in to your mfkg journey and for you to be a part of theirs.

* **Tangible reminders**: Give customers a little something extra (like stickers, notepads, hand tools, pens, etc.) that both overdeliver and serve as a positive reminder of what you offer.
* **Beta testers**: Invite customers to try out your product (or new/next versions) ahead of primetime releases. 
* **Open Kitchen**: Let customers see how the food is made by showing what's going on behind the scenes.
* **Information Sharing**: In a world of proprietary product development, allowing customers (and potential new customers) to be part of something open and collectively shared can be a powerful message of inclusion.
